...
[file:samples/1_simple-left-to-right.png]
...
* Beginner's guide
  ...
  The file file:powerline-for-polybar.config contains pre-configured templates to be inherited by your Polybar modules in
  ...
  file:powerline-for-polybar.config for parameters that must be set, as they are documented along each templates. A
...
** Simple Powerline bar
   ...
   file:samples/1_simple-left-to-right.config):
...
the right-to-left equivalent of this example is file:samples/3_simple-right-to-left.config.

file:samples/3_simple-right-to-left.png
...
configuration file is file:samples/4_separated-left-to-right.config):

file:samples/4_separated-left-to-right.png
...
You should now have something like this (file:samples/6_separated-left-to-right-noborder.config):

file:samples/6_separated-left-to-right-noborder.png

#+BEGIN_QUOTE
In case you forget to use the =powerline/left-to-right-starting-item-with-separator= for the first module, this is what
to expect, but might be intended (file:samples/5_separated-left-to-right-nostarting-noborder.config):

file:samples/5_separated-left-to-right-nostarting-noborder.png
#+END_QUOTE
...
Again, right-to-left equivalent is available (file:samples/7_separated-right-to-left.config):

file:samples/7_separated-right-to-left.png
